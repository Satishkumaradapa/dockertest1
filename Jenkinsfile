pipeline {
    ...
    stages { 
	    ...
	    stage('Build Docker Image') {
		  steps {
	        sh 'sudo cd :/var/lib/jenkins/workspace/pipelinetest/dockertest1'
	        sh 'sudo cp -r :/var/lib/jenkins/workspace/pipelinetest/dockertest1/* :/var/lib/jenkins/workspace/pipelinetest'
